...
const roles ={
    ...
    8: [LoupGarou, Voyante, Voleur, Divinateur, LoupShaman, FrancMacon, FrancMacon, Gremlin],
    9: [LoupGarou, Voyante, ChasseurDeFantomes, Divinateur, LoupShaman, FrancMacon, FrancMacon, Espion, Gremlin],
    10: [LoupGarou, Voyante, ChasseurDeFantomes, Divinateur, LoupShaman, FrancMacon, FrancMacon, Espion, Gremlin, Insomniaque],
...
module.exports  = function shambler(players) {
    ...
    players.forEach(player => {
        ...
        if(player.member) {
            player.sendDM("Que la partie commence !!!\n Commençons par découvir votre rôle secret")
            player.sendRole()
        }
        count++;
    })
